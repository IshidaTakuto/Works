...
/*			草クラス			 */
/*===============================*/
class CWeed : public CScene3D
{
public:
	CWeed(int nPriority = MODEL_PRIORITY, CScene::OBJTYPE objType = CScene::OBJTYPE_WEED);
	~CWeed();
	...
	static CWeed *Create(D3DXVECTOR3 pos);

protected:

private:
	static LPDIRECT3DTEXTURE9	m_pTexture;		// テクスチャ情報
	bool	m_bMove;		// 左右どちらに揺れるか
	float	m_fMove;		// 揺れ幅
};
