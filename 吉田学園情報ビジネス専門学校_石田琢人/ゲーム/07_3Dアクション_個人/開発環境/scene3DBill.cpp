...
// サイズの設定
//=========================================
const void CScene3DBill::SetSize(D3DXVECTOR3 size)
{
	// サイズの設定
	m_fWidth = size.x;
	m_fHeight = size.y;
	...
	pVtx[0].pos = D3DXVECTOR3(0.0f, m_fHeight, size.z);
	pVtx[1].pos = D3DXVECTOR3(m_fWidth, m_fHeight, size.z);
	pVtx[2].pos = D3DXVECTOR3(0.0f, 0.0f, size.z);
	pVtx[3].pos = D3DXVECTOR3(m_fWidth, 0.0f, size.z);
...
// 幅の設定
//=========================================
const void CScene3DBill::SetWidth(float fWidth)
{
	m_fWidth = fWidth;
...
// 高さの設定
//=========================================
const void CScene3DBill::SetHeight(float fHeight)
{
	m_fHeight = fHeight;
