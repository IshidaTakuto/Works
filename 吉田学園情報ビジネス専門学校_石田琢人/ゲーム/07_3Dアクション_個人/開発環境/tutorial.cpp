...
// マクロ定義
//*****************************************************************************
#define TUTORIAL_TEXTURE00	"data/TEXTURE/tutorial.jpg"
...
HRESULT CTutorial::Init(void)
{
	...
	// テクスチャの生成
	D3DXCreateTextureFromFile(pDevice, TUTORIAL_TEXTURE00, &m_pTexture);		// テクスチャの生成
	m_pPolygon->BindTexture(m_pTexture);										// テクスチャの設定
