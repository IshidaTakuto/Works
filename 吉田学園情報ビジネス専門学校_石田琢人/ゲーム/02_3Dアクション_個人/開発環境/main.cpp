...
#define WINDOW_NAME		"The Season"	// ウインドウのキャプション名
...
void SetMode(MODE mode)
{
	...
	case MODE_TITLE:
		...
		*LightType = LIGHTTYPE_TITLE;
		pCamera->type = CAMERATYPE_TITLE;
		break;

	case MODE_MENU:
		InitMenu();
		pCamera->type = CAMERATYPE_MENU;
		break;
	...
	case MODE_GAME:
		...
		*LightType = LIGHTTYPE_NORMAL;
		pCamera->type = CAMERATYPE_GAME;
		break;

	case MODE_RESULT:
		PlaySound(SOUND_LABEL_GAME000);
		InitResult();
		*LightType = LIGHTTYPE_RESULT;
		pCamera->type = CAMERATYPE_RESULT;
		break;
