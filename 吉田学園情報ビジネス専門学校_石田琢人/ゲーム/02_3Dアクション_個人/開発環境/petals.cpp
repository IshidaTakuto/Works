...
#define MAX_PETALS			(1020)		// 花びらの最大数
#define PETALS_FIELD		(2500 / 2)		// 中心を0とした範囲
#define TITLE_PETALS_FIELD	(200)		// 中心を0とした範囲
	...
	for (nCntPetals = 0; nCntPetals < MAX_PETALS; nCntPetals++)
	{
		...
		case MODE_TITLE:
			...
			case PETALSTYPE_SAKURA:
				g_nCntPetals = (g_nCntPetals + 1) % 2;	// 花びらを出す間隔
		...
		case MODE_GAME:
			g_nCntPetals = (g_nCntPetals + 1) % PETALS_APPEAR;	// 花びらを出す間隔
