...
HRESULT CPolygon::Load(void)
{
	...
	char aTexName[TYPE_MAX][128] =				// テクスチャの名前
	{
		"data/TEXTURE/press_any.png",			// PRESS_ANY
		"data/TEXTURE/continue.png",			// ポーズ中のコンテニュー
		"data/TEXTURE/retry.png",			// ポーズ中のリトライ
		"data/TEXTURE/quit.png",			// ポーズ中のタイトルに戻る
		"data/TEXTURE/title_logo.png",			// タイトルのロゴ
		"data/TEXTURE/clear_logo.png",			// ゲームクリアのロゴ
		"data/TEXTURE/over_logo.png",			// ゲームオーバーのロゴ
		"data/TEXTURE/ranking_logo.png",		// ランキングのロゴ
		"data/TEXTURE/communicate_window.jpg",	// 通信ウィンドウ
		"data/TEXTURE/stock00.png",				// ストックアイコン
		"data/TEXTURE/stock01.png",				// ストックアイコン
		"data/TEXTURE/stock02.png",				// ストックアイコン
	};
