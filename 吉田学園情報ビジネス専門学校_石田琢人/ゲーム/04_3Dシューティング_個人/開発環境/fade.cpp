...
HRESULT CFade::Init(void)
{
	...
	pos[1] = D3DXVECTOR3(SCREEN_WIDTH, 0.0f, 0.0f);
	pos[2] = D3DXVECTOR3(0.0f, SCREEN_HEIGHT, 0.0f);
	pos[3] = D3DXVECTOR3(SCREEN_WIDTH, SCREEN_HEIGHT, 0.0f);

	CScene2D::SetVtxPos(&pos[0]);	// 頂点座標を設定
