...
void CDebugProc::Print(char *fmt, ...)
{
	...
	// 文字列を全角にする
	char aStr[256];
	LCMapString(0x0411, LCMAP_FULLWIDTH, aSource, -1, aStr, 256);
...
{
	RECT rect = { 12,12,SCREEN_WIDTH,SCREEN_HEIGHT };	// 表示する座標
	...
	{// 表示する
		m_pFont[0]->DrawText(						// 影をつける
			...
			D3DXCOLOR(0.2f, 0.1f, 0.0f, 1.0f));	//色
...
// 表示・非表示の切り替え
//=============================================================================
void CDebugProc::DebugDisp(void)
{
